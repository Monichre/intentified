...
import { DocumentStatus } from "@/features/dashboard/document-processing/document-status";
import {
  startAnalysis,
  startExtraction,
  uploadDocument,
} from "@/features/dashboard/document-processing/actions";
  ...
  const icon = (() => {
    switch (status) {
      case "idle":
        return <FileSpread />;
      case "loading":
        return <Loader2 className="text-primary size-7 animate-spin" />;
      case "uploading":
      ...
      case "analyzing":
        return <FileAiIcon className="size-7" />;
      case "error":
        return <AlertCircle className="text-destructive size-7" />;
      case "success":
        return (
          <FileText className="text-primary size-7 fill-green-300 stroke-green-600" />
        );
    }
  })();
...
function UploadStateMessage({
  ...
  switch (status) {
        ...
        <>
          ...
          <div className="flex flex-col items-center gap-2 text-center">
            <p className="text-muted-foreground text-sm">
              ...
              <span className="text-primary cursor-pointer font-medium underline-offset-2 hover:underline">
                browse
              </span>
            </p>
            <div className="text-muted-foreground/80 bg-muted/50 flex items-center gap-2 rounded-lg px-3 py-1.5 text-xs">
              <span>Supports</span>
              <div className="flex items-center gap-1.5">
                <span className="rounded bg-red-100 px-1.5 py-0.5 font-medium text-red-700 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
                  PDF
                </span>
                <span className="rounded bg-blue-100 px-1.5 py-0.5 font-medium text-blue-700 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
                  TXT
                </span>
                <span className="rounded bg-green-100 px-1.5 py-0.5 font-medium text-green-700 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
                  DOCX
                </span>
              </div>
              <span>up to 2MB</span>
    ...
    case "error":
      return (
        <>
          <h3 className="text-destructive font-medium">Upload failed</h3>
...
export function UploadZoneWrapper() {
  ...
  return (
    <div className="relative rounded-[1.65rem] p-1 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
      <div {...getRootProps()} className="relative">
        <motion.div
          className={cn(
            "relative cursor-pointer rounded-3xl border-[1px] border-black/10 shadow-inner transition-colors",
        ...
        >
          <input {...getInputProps()} />
          <motion.div
            className="relative flex flex-col items-center justify-center space-y-4 p-12 text-center"
            layout="position"
            transition={animations.quickSpring}
          >
            {/* Add subtle background pattern for idle state */}
            {uploadState.status === "idle" && (
              <div className="pointer-events-none absolute inset-0 opacity-[0.03] select-none">
                <div
