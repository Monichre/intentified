  ...
  return (
    <Drawer shouldScaleBackground>
      <DrawerTrigger asChild>
        <div
          className="group hover:bg-muted/50 relative cursor-pointer overflow-hidden rounded-3xl p-4 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)] transition-colors"
