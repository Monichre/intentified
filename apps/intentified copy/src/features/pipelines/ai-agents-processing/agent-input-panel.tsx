...
import type { ExamplePrompt, AgentType } from "../lib/types";
              ...
              {field.type === "textarea" ? (
                <div className="group relative rounded-[9px] p-1 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
                  <Textarea
                    ...
                    className={cn(
                      "resize-none rounded-[5px] border-none text-[16px] leading-snug caret-blue-400 shadow-[0px_1px_0px_0px_hsla(0,_0%,_0%,_0.02)_inset,_0px_0px_0px_1px_hsla(0,_0%,_0%,_0.02)_inset,_0px_0px_0px_1px_rgba(255,_255,_255,_0.25)] ring-1 ring-[#F6F6F6] ring-offset-1 ring-offset-neutral-50 transition-all duration-200 ease-out focus-visible:ring-[1px] focus-visible:ring-[#2B7BE5] focus-visible:ring-offset-2 focus-visible:ring-offset-blue-100 md:text-[14px] md:leading-relaxed",
          ...
          <Card className="relative rounded-lg border-none px-2 pt-2 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
            <div className="space-y-3 text-[10px] text-neutral-600">
              <div className="space-y-1.5 p-2">
                <h4 className="flex items-center gap-1 py-[2px] text-[10px] font-medium text-neutral-900">
...
function ExampleButtons({
  ...
  return (
    <motion.div
      className="flex-none rounded-t-2xl border-b border-neutral-100/80 bg-[#FAFAFA]/50 p-2 sm:p-3 md:p-4"
      variants={fadeIn}
      initial="initial"
      animate="animate"
    >
      <div className="space-y-2 sm:space-y-3">
        ...
        >
          <Label className="text-[11px] font-medium text-neutral-600 sm:text-xs">
            Quick Examples
          </Label>
        ...
        >
          <ScrollArea className="bg-muted ring-border w-full rounded-[9px] whitespace-nowrap shadow-[0px_1px_0px_0px_hsla(0,_0%,_0%,_0.02)_inset,_0px_0px_0px_1px_hsla(0,_0%,_0%,_0.02)_inset,_0px_0px_0px_1px_rgba(255,_255,_255,_0.25)] ring-[1px]">
            <div
                ...
                >
                  ...
                  {index === selectedExampleIndex && (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="absolute top-1 right-1.5 -translate-y-1/2 cursor-pointer rounded-full bg-white/20 p-0.5 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.2)] backdrop-blur-[2px] transition-colors duration-200 hover:bg-white/30"
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        onExampleSelect(example, -1);
  ...
  return (
    <div className="flex items-center justify-between gap-3 bg-[#FAFAFA]/50 px-4 py-4">
      <Button
        ...
        className="group h-9 gap-1.5 rounded-lg border border-[#E0E0E0] bg-[#FFFFFF] text-[#36322F] [box-shadow:inset_0px_-2.108433723449707px_0px_0px_#E0E0E0,_0px_1.2048193216323853px_6.325301647186279px_0px_rgba(0,_0,_0,_10%)] active:bg-[#F0F0F0] active:[box-shadow:inset_0px_-1.5px_0px_0px_#D8D8D8,_0px_0.5px_2px_0px_rgba(0,_0,_0,_15%)] hover:enabled:bg-[#F8F8F8] hover:enabled:[box-shadow:inset_0px_-2.53012px_0px_0px_#E8E8E8,_0px_1.44578px_7.59036px_0px_rgba(0,_0,_0,_12%)] disabled:bg-[#F0F0F0] disabled:shadow-none"
      >
        {isMobile ? (
                ...
                try {
                  ...
                  return (
                    <DropdownMenuItem
                      ...
                      className="cursor-pointer px-3 py-2.5 break-all hover:bg-neutral-50"
                    >
      ...
      <div className="relative w-full">
        ...
        <button
          ...
          className="relative inline-flex h-9 w-full items-center justify-center gap-1 rounded-lg bg-[#36322F] px-2.5 py-1.5 text-center text-sm text-zinc-50 [box-shadow:inset_0px_-2.108433723449707px_0px_0px_#171310,_0px_1.2048193216323853px_6.325301647186279px_0px_rgba(58,_33,_8,_58%)] outline outline-1 outline-[#fff2f21f] hover:bg-[#4a4542] hover:[box-shadow:inset_0px_-2.53012px_0px_0px_#171310,_0px_1.44578px_7.59036px_0px_rgba(58,_33,_8,_64%)]"
        >
          {loading ? (
            <>
