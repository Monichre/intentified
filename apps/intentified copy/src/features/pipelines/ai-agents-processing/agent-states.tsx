      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <motion.div variants={staggerItemVariants} className="space-y-1">
          <div className="space-y-1">
            <motion.h3
              variants={fadeIn}
              className="relative mx-auto mb-1 w-fit rounded-full bg-blue-600 px-1.5 text-[10px] font-medium tracking-wide text-white shadow-[0_1px_2px_rgba(0,0,0,0.15),_inset_0_1px_0.5px_rgba(255,255,255,0.2),_0_-0.5px_1px_rgba(0,0,0,0.08)_inset,_0_0_0_1px_rgba(0,0,0,0.08)_inset]"
            >
              <span className="relative z-10">Agent Pattern</span>
            </motion.h3>

            <TextRoll className="text-lg font-bold lg:text-3xl">{`${agent.name}`}</TextRoll>
          </div>
          {/* Tools & Time */}
          <motion.div
            className="inline-flex min-w-24 items-center gap-3 rounded-full border border-blue-100 p-1 px-1.5 text-xs font-medium"
            whileHover={{ y: -2 }}
        ...
        <motion.div variants={staggerItemVariants} className="w-full">
          ...
          >
            {/* Card Header */}
            <div className="border-b border-neutral-100 bg-neutral-50/50 px-4 py-3 sm:px-6">
              <div className="flex items-center gap-2">
                <Sparkles className="h-3.5 w-3.5 text-blue-500" />
                <div className="text-xs font-medium text-neutral-700 sm:text-sm">
                  Agent Details
                </div>
              </div>
            </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {agent.capabilities.map((capability, index) => (
                        <motion.div
                          key={index}
                          variants={staggerItemVariants}
                          className="group flex items-center gap-2 rounded-full border border-neutral-200/80 bg-neutral-50 px-2.5 py-1 text-xs text-neutral-600 transition-colors duration-200 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-600"
                        >
  ...
  return (
    ...
    >
      <Card className="mt-1 space-y-8 rounded-2xl border-none p-0 pt-1 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
        <div className="space-y-6 p-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div>
                <div className="flex items-center gap-2 pb-1">
                  <div className="relative rounded-full bg-blue-600 px-1.5 py-[2px] text-[10px] font-medium tracking-wide text-white shadow-[0_1px_2px_rgba(0,0,0,0.15),_inset_0_1px_0.5px_rgba(255,255,255,0.2),_0_-0.5px_1px_rgba(0,0,0,0.08)_inset,_0_0_0_1px_rgba(0,0,0,0.08)_inset]">
                ...
                <div className="flex items-center gap-1 px-[2px] py-[2px] pl-1">
                  <div className="flex items-center space-x-2 text-sm text-neutral-500">
                    ...
                    <div className="flex items-center gap-1 px-[2px] py-[1px] pl-1">
                      <p className="text-muted-foreground/60 text-[9px] font-medium tracking-wide">
                        Input fields
                      </p>
            ...
            <motion.p
              ...
              variants={staggerItemVariants}
              className="text-sm text-pretty text-neutral-600 lg:pr-6"
            >
              {agent.description}
            </motion.p>
          </div>
          ...
          >
            <div className="space-y-4 rounded-lg bg-neutral-50 p-4 shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
              <div>
                <h4 className="mb-1 text-xs font-medium text-neutral-900">
                  Best Use Cases
                </h4>
                <p className="text-xs text-neutral-600">{agent.context}</p>
              </div>
              <div className="space-y-4 border-t border-neutral-200 pt-4">
                <div>
                  <h4 className="mb-2 text-xs font-medium text-neutral-900">
                    Inputs
                  </h4>
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-600">{agent.output}</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="flex flex-wrap gap-2">
              {agent.capabilities?.map((capability) => (
                <Badge
                  key={capability}
                  variant="secondary"
                  className="bg-muted rounded-full border border-black/10 shadow-sm"
                >
                  {capability}
                </Badge>
              ))}
        ...
        {/* Footer */}
        <div className="flex items-center justify-between rounded-b-2xl border-t border-neutral-100 bg-[#F7F7F8] px-8 py-4">
          <Button
            variant="ghost"
            size="sm"
...
function CircularProgress({
  ...
  return (
    <div className="group relative inline-flex">
      ...
      <motion.div
        className="absolute -inset-4 rounded-full bg-blue-500/5 blur-lg"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.5, 0.8, 0.5],
        }}
...
function Countdown({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex items-center gap-2 rounded-full bg-white/90 px-2.5 py-1.5 text-xs font-medium",
      ...
      <NumberFlowGroup>
        ...
        >
          ...
          <div className="flex items-baseline">
            ...
            <span
              className={cn(
                "ml-0.5 text-[10px] font-medium transition-colors duration-200",
                loading ? "text-blue-400" : "text-neutral-400",
              )}
            >
              ms
