    ...
    <TabsContent value="classification" className="mt-4 space-y-4">
      <Card className="p-4">
        <div className="space-y-4">
          <div>
            <h4 className="mb-2 text-sm font-medium">Query Classification</h4>
          ...
          <div className="border-t pt-4">
            <h4 className="mb-2 text-sm font-medium">Routed Response</h4>
            <MemoizedReactMarkdown>
              {parsedOutput.response}
            </MemoizedReactMarkdown>
          </div>
          ...
          <div className="space-y-2">
            ...
            {tool.output && (
              <div className="border-t pt-2">
                <h4 className="mb-1 text-xs font-medium">Output</h4>
...
export function OutputPanel({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "bg-muted flex min-h-0 flex-col overflow-hidden",
        "h-full w-full",
        "md:w-1/2 lg:w-3/5",
      )}
    >
      <h2 className="absolute top-4 right-4 hidden text-[9px] font-medium text-neutral-400 md:block">
        {loading ? "Processing..." : "Output"}
      </h2>
      {/* Header with Indicators */}
      <div className="border-border/50 flex w-full flex-none items-center justify-between border-b px-4 py-2">
