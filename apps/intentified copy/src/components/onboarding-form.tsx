...
export const OnboardingForm = () => {
  ...
  const addCompetitorIntent = () => {
    setFormData((prev) => ({
      ...prev,
      competitorIntents: [...prev.competitorIntents, ""],
    }));
  };
  ...
  const addSocialIntent = () => {
    setFormData((prev) => ({
      ...prev,
      socialIntents: [...prev.socialIntents, ""],
    }));
  };
  ...
  const addKeywordIntent = () => {
    setFormData((prev) => ({
      ...prev,
      keywordIntents: [...prev.keywordIntents, ""],
    }));
  };
                    ...
                    <CardContent className="space-y-4">
                      <motion.div variants={fadeInUp} className="space-y-2">
                        ...
                        <Input
                          ...
                          className="focus:ring-primary/20 focus:border-primary transition-all duration-300 focus:ring-2"
                        />
                      </motion.div>
                      <motion.div variants={fadeInUp} className="space-y-2">
                    ...
                    <CardContent className="space-y-4">
                      <motion.div variants={fadeInUp} className="space-y-2">
                        ...
                        >
                          {[
                            ...
                            <motion.div
                              key={goal.value}
                              className="hover:bg-accent flex cursor-pointer items-center space-x-2 rounded-md border p-3 transition-colors"
                      ...
                      <motion.div variants={fadeInUp} className="space-y-2">
                        ...
                        <Textarea
                          ...
                          className="focus:ring-primary/20 focus:border-primary min-h-[80px] transition-all duration-300 focus:ring-2"
                        />
                      </motion.div>
                    </CardContent>
                  </>
