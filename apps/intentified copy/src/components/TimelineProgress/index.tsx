...
export const TimelineProgress = (props: TimelineProgressProps) => {
  const { actions = [] } = props;
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center gap-2 rounded-2xl border border-[#e2e2e2] bg-white px-3 py-2 text-[15px] text-[#171717] [&_svg]:h-5 [&_svg]:w-5"
      >
      ...
      {index !== actions.length - 1 && (
        <div className="flex h-[54px] items-center justify-center">
          <div className="h-[2px] w-[54px] rotate-90 bg-[#e8e8e8]">
            <motion.div
