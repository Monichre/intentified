    ...
    <div className="absolute z-20 flex justify-center">
      ...
      >
        ...
        {isHovered && (
          ...
          >
            <div
              className="flex gap-1 rounded-full border border-[#20dfd6] bg-[#022323] p-[6px] px-[10px]"
              style={{ transform: "translate(-50%, -50%)" }}
            >
              <Dot delay={0} color="#20dfd6" isRunning={isHovered} />
              <Dot delay={0.2} color="#20dfd6" isRunning={isHovered} />
              <Dot delay={0.4} color="#20dfd6" isRunning={isHovered} />
            </div>
          </div>
        )}
        ...
        >
          <ArrowCursorIcon />
          <div className="absolute -top-6 left-full flex h-8 w-[65px] items-center justify-center gap-1 rounded-full border border-[rgb(137,137,137)/0.7] bg-neutral-800">
            <Dot delay={0} isRunning={isHovered} />
            <Dot delay={0.2} isRunning={isHovered} />
            <Dot delay={0.4} isRunning={isHovered} />
          </div>
        </motion.div>
        ...
        >
          <ArrowCursorIcon />
          <div
            className={`absolute -top-6 left-full h-8 w-[65px] items-center justify-center gap-1 rounded-full border border-[rgb(137,137,137)/0.7] bg-neutral-800 ${
