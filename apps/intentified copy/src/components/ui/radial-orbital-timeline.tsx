...
import IntentifiedProcessCard from "./intentified-process-card";
...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="flex w-full flex-col items-center justify-center overflow-hidden bg-transparent"
      ref={containerRef}
    ...
    >
      <div className="relative flex h-auto w-full max-w-4xl items-center justify-center">
        <div
          className="absolute flex h-[500px] w-full items-center justify-center"
          ref={orbitRef}
          style={{
            perspective: "1000px",
