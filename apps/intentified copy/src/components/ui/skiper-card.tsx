    ...
    <FeatureCard {...props}>
      <div
        className={cn(
          ...
          "absolute top-1/3 left-2/4 flex w-full -translate-x-1/2 -translate-y-[33%] flex-col gap-12 text-center text-2xl font-bold transition-all duration-500 md:w-3/5",
        )}
      >
        <Image
          alt={image.alt}
          className="pointer-events-none top-1/2 w-[90%] overflow-hidden rounded-2xl border border-neutral-100/10 transition-all duration-500 md:top-[30%] md:left-[35px] md:w-full dark:border-zinc-700"
      ...
      <>
        ...
        />
        <div className="absolute top-5 left-48 z-50 size-full cursor-pointer md:left-0">
