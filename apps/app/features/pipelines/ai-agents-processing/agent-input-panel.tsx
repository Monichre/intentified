...
import { fadeIn, slideInFromRight, staggerContainerVariants, staggerItemVariants } from "../lib/animations"
...
export function InputPanel({
  ...
  const hasMultipleTextAreas = selectedAgent.inputFields.filter((f) => f.type === "textarea").length > 1
  ...
  return (
    ...
    >
      ...
      <ScrollArea className="flex-1 w-full">
        <motion.div className="p-2 sm:p-4 space-y-5" variants={staggerContainerVariants} key={selectedAgent.name}>
          {selectedAgent.inputFields.map((field, index) => (
            <motion.div variants={staggerItemVariants} key={index} className="space-y-2.5">
              <div className="flex items-center gap-1.5">
                <Label className={cn("text-xs font-medium transition-all duration-200")}>{field.label}</Label>
                <AnimatePresence>
                ...
                <div className="relative p-1 rounded-[9px] group shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
                  <Textarea
                    ...
                    className={cn(
                      ...
                      hasMultipleTextAreas ? "min-h-[150px] lg:min-h-[130px]" : "min-h-[220px] lg:min-h-[240px]",
      ...
      {/* Agent Info Card */}
      <motion.div className="flex-none border-t border-neutral-100/80 bg-[#FCFCFC] " variants={fadeIn}>
          ...
          <Card className=" border-none rounded-lg px-2 pt-2 relative shadow-[0px_1px_1px_0px_rgba(0,_0,_0,_0.05),_0px_1px_1px_0px_rgba(255,_252,_240,_0.5)_inset,_0px_0px_0px_1px_hsla(0,_0%,_100%,_0.1)_inset,_0px_0px_1px_0px_rgba(28,_27,_26,_0.5)]">
            <div className="text-[10px] text-neutral-600 space-y-3 ">
              <div className="space-y-1.5 p-2 ">
                ...
                <div className="leading-relaxed text-[10px] ">{selectedAgent.context}</div>
              </div>
              <div className="flex flex-col sm:flex-row gap-4">
                <div className=" min-w-[100px] flex items-center gap-1  pl-1  absolute top-1.5 right-1.5  rounded-md px-[2px] py-[1px] ">
                  <p className="font-medium text-muted-foreground/60  text-[9px]">Average Processing Time</p>
  ...
  return (
    ...
    >
      <div className="space-y-2 sm:space-y-3">
        ...
        >
          <Label className="text-[11px] sm:text-xs font-medium text-neutral-600">Quick Examples</Label>
          <Tooltip delayDuration={300}>
            ...
            >
              <p className="leading-relaxed">
                This is the Input Panel for the Agent. Different agents have different input fields. Select an example
                to get started.
              </p>
            </TooltipContent>
          </Tooltip>
        ...
        >
          <ScrollArea className="whitespace-nowrap w-full bg-muted ring-border ring-[1px] rounded-[9px] shadow-[0px_1px_0px_0px_hsla(0,_0%,_0%,_0.02)_inset,_0px_0px_0px_1px_hsla(0,_0%,_0%,_0.02)_inset,_0px_0px_0px_1px_rgba(255,_255,_255,_0.25)]">
            <div key={`${selectedAgent.id}-examples-container`} className="flex w-max space-x-2 p-1.5">
              {examplePrompts.map((example, index) => (
                ...
                >
                  {(() => {
                    const text = example.prompt || example.content || example.query || example.requirements
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 w-full">
                        <div className="flex-1 truncate text-sm">{formatDisplayText(displayText)}</div>
        ...
        >
          {loading ? (
            ...
            <>
              ...
              <span className="text-xs">{isMobile ? "Run & View Output" : "Run Agent"}</span>
            </>
          )}
        </button>
      </div>
...
const DeletePutBackIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M19 13.5L19.5 5.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
)
